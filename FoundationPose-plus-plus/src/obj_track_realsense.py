...
if __name__ == "__main__":
    ...
    parser.add_argument('--yolo_model_path', type=str, required=True, help='Path to YOLO segmentation model')
    parser.add_argument('--target_class_name', type=str, default='blue_tube', help='Target class name to segment')
    args = parser.parse_args()
    # Load YOLO model and class name
